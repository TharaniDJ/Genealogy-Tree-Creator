  ...
  return (
    <div className="person-node">
      ...
      <div className={`w-48 backdrop-blur-xl bg-white/10 border-2 rounded-xl shadow-2xl p-4 text-center transition-all duration-200 ${
        ...
        <div className="w-16 h-16 mx-auto mb-2 rounded-full overflow-hidden bg-gradient-to-r from-[#6B72FF] to-[#8B7BFF] border border-white/20 flex items-center justify-center">
          <span className="text-white w-full h-full flex items-center justify-center text-xl font-bold">
            {getInitials(data.entity)}
          </span>
        </div>
