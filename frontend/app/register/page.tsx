...
import { UserPlus, Mail, Lock, User, Network, ArrowLeft, Eye, EyeOff } from 'lucide-react';
            ...
            <form onSubmit={submit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#9CA3B5]" />
                  <input
                    type="text"
                    required
